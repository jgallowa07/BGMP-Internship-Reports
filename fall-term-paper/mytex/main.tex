...
%In the context viral immunology, these assays have given us the ability to explore and measure the fitness of a particular protein and it's respective binding affinity to other proteins of interest.
%The insights gained have laid the foundation for understanding the .
...
(a) & (b) \\[6pt]
% \includegraphics[width=85mm]{figures/42_mockip_abundance_variance/counts/mean.pdf} &   \includegraphics[width=85mm]{figures/42_mockip_abundance_variance/counts/std.pdf} \\
